...
export function AuthorNotesPanel({
  ...
  // Safety net: if the dialog unmounts during the debounce window (close via X,
  // backdrop, or Escape), flush any pending edit synchronously so the mutation
  // fires before React tears the component down.
  useEffect(() => {
    return () => {
